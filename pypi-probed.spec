...
Source0  : https://files.pythonhosted.org/packages/f1/dc/1d881a60b0012d14ace5778dd9d2ec5f5d68605878f9506112e39982bbc1/probed-0.0.10.tar.gz
...
%prep
%setup -q -n probed-0.0.10
cd %{_builddir}/probed-0.0.10
pushd ..
cp -a probed-0.0.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663346398
...
cp %{_builddir}/probed-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-probed/4bf523651dbfe0fa3a55d23d58726a25299355ac || :
